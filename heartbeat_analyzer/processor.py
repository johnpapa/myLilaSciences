...
def parse_heartbeat_file(file_path: Path) -> List[HeartbeatRecord]:
    """Parse a JSONL file and return validated heartbeat records."""
...
def format_timestamp(timestamp: datetime) -> str:
    """Normalize timestamps to UTC and format as ISO 8601."""
...
def average_interval_seconds(sorted_records: List[HeartbeatRecord]) -> float:
    """Return average interval in seconds between consecutive heartbeats."""
...
def detect_prolonged_unknown(sorted_records: List[HeartbeatRecord]) -> List[Dict[str, Any]]:
    """Detect runs of three or more consecutive UNKNOWN heartbeat statuses."""
...
def analyze_file(file_path: Path) -> Dict[str, Any]:
    """Analyze an input file and produce the final report."""
